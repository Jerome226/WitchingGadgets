...
public class WGConfig {
    ...
    public static void loadConfig(FMLPreInitializationEvent event) {
        ...
        String[] clusters = {
                ...
                "FZDarkIron",
                // Metallurgy
                "Manganese", "Zinc", "Platinum", "Ignatius", "ShadowIron", "Lemurite", "Midasium", "Vyroxeres",
                "Ceruclase", "Alduorite", "Kalendrite", "Vulcanite", "Sanguinite", "Prometheum", "DeepIron",
                "Infuscolium", "Oureclase", "AstralSilver", "Carmot", "Mithril", "Rubracium", "Orichalcum",
                "Adamantine", "Atlarus", "Eximite", "Meutoite",
                // Others
                "Uranium" };
        tripplingClusterList = config.get(
                "Ore/Crucible",
                "Trippling Cluster List",
                clusters,
                "A list of ore names for which the clsuters should smelt into three ingots. This is so that custom AOBD clusters can be thrown into the Blast Furnace")
                .getStringList();

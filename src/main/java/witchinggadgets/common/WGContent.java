...
public class WGContent {
    ...
    public static ArmorMaterial primordialArmor = EnumHelper
            .addArmorMaterial("WG:PRIMORDIALARMOR", 40, new int[] { 3, 7, 6, 3 }, 30);
    ...
    private static void postInitBlocks() {
        ...
        for (int yy = 0; yy <= 1; yy++) for (int zz = 0; zz <= 2; zz++) for (int xx = 0; xx <= 2; xx++) {
            ...
            if (rc) TileEntityBlastfurnace.brickBlock[pos] = GameRegistry.findBlock("Railcraft", "brick.infernal");
        ...
        TileEntityBlastfurnace.stairBlock = rc ? GameRegistry.findBlock("Railcraft", "stair")
    ...
    private static void initializeItems() {
        ...
        GameRegistry.addRecipe(
                new ShapedOreRecipe(new ItemStack(BlockMetalDevice, 1, 1), "vvv", "vvv", "vvv", 'v', "ingotVoid"));
        ItemStack voidIngot = OreDictionary.getOres("ingotVoid").get(0);
        GameRegistry.addRecipe(
                new ShapelessOreRecipe(new ItemStack(voidIngot.getItem(), 9, voidIngot.getItemDamage()), "blockVoid"));

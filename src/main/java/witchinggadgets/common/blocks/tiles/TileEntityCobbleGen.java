...
public class TileEntityCobbleGen extends TileEntityWGBase {
    ...
    private void createCobble() {
        ...
        if ((inventory != null) && ((inventory instanceof IInventory))) cobble = InventoryUtils
    ...
    private boolean canOutput() {
        TileEntity inventory = this.worldObj.getTileEntity(
                ...
                this.yCoord + this.facing.offsetY,
                this.zCoord + this.facing.offsetZ);
        if ((inventory != null) && ((inventory instanceof IInventory))) return InventoryUtils.insertStack(

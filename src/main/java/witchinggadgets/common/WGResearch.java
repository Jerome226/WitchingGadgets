...
public class WGResearch {
    ...
    public static void registerRecipes() {
        ...
        if (WGModCompat.loaded_Twilight) registerShapelessArcaneRecipe(
                ...
                new Object[] { "dustGold", new ItemStack(WGModCompat.tfMagicMapFocus),
        ...
        if (WGConfig.moduleCloak) {
            ...
            if (WGConfig.capeSpectral) {
                infusionAspects = new AspectList().add(Aspect.SOUL, 8).add(Aspect.TRAVEL, 8).add(Aspect.ELDRITCH, 4)
                        .add(Aspect.SENSES, 4);
                registerInfusionRecipe(
                        "CLOAK_SPECTRAL",
                        "",
            ...
            if (WGConfig.moduleKama) {
                ...
                // super("CLOAKKAMA", new ItemStack(), new AspectList().add().add(), new Object[]{"B","C", 'B',
                // "baubleBeltBase", 'C', });
        ...
        if (WGConfig.moduleBag) {
            ...
            if (WGConfig.bagVoid) {
                infusionAspects = new AspectList().add(Aspect.VOID, 16).add(Aspect.ELDRITCH, 16)
        ...
        infusionAspects = new AspectList().add(Aspect.MINE, 8).add(Aspect.TOOL, 4).add(Aspect.MOTION, 4)
                .add(Aspect.AIR, 8);
        registerInfusionRecipe(
                "WGBAUBLES",
                "_HASTEVAMBRACES",
        ...
        registerInfusionRecipe(
                ...
                new ItemStack[] { new ItemStack(Items.ender_pearl), new ItemStack(WGContent.ItemMaterial, 1, 0),
                        new ItemStack(WGContent.ItemMaterial, 1, 0), new ItemStack(WGContent.ItemMaterial, 1, 0) });
        ...
        if (WGConfig.modulePrimal) {
            infusionAspects = new AspectList().add(Aspect.AIR, 16).add(Aspect.FIRE, 16).add(Aspect.EARTH, 16)
            ...
            if (WGConfig.moduleGemcutting) {
                infusionAspects = new AspectList().add(Aspect.MAGIC, 32).add(Aspect.CRYSTAL, 16).add(Aspect.TOOL, 8)
            ...
            infusionAspects = new AspectList().add(Aspect.MAGIC, 64).add(Aspect.METAL, 128).add(Aspect.WEAPON, 64)
            ...
            infusionAspects = new AspectList().add(Aspect.MAGIC, 64).add(Aspect.METAL, 128).add(Aspect.TOOL, 32)
            ...
            //
            infusionAspects = new AspectList().add(Aspect.MAGIC, 64).add(Aspect.METAL, 128).add(Aspect.ARMOR, 32)
                    .add(Aspect.AIR, 32).add(Aspect.FIRE, 32).add(Aspect.WATER, 32).add(Aspect.EARTH, 32)
                    .add(Aspect.ORDER, 32).add(Aspect.ENTROPY, 32);
            registerInfusionRecipe(
                    "PRIMORDIALARMOR",
            ...
            // {
            // registerInfusionRecipe("PRIMODIALARMORUPGRADE_"+pau,"_HELMET",new Object[]{"primordialUpgrade",new
            // NBTTagByte((byte)pau.ordinal())},8,pau.getAspects(),new
            // ItemStack(WGContent.ItemPrimordialHelm),pau.getCompenents());
            // registerInfusionRecipe("PRIMODIALARMORUPGRADE_"+pau,"_CUIRASS",new Object[]{"primordialUpgrade",new
            // NBTTagByte((byte)pau.ordinal())},8,pau.getAspects(),new
            // ItemStack(WGContent.ItemPrimordialChest),pau.getCompenents());
            // registerInfusionRecipe("PRIMODIALARMORUPGRADE_"+pau,"_GREAVES",new Object[]{"primordialUpgrade",new
            // NBTTagByte((byte)pau.ordinal())},8,pau.getAspects(),new
            // ItemStack(WGContent.ItemPrimordialLegs),pau.getCompenents());
            // registerInfusionRecipe("PRIMODIALARMORUPGRADE_"+pau,"_BOOTS",new Object[]{"primordialUpgrade",new
            // NBTTagByte((byte)pau.ordinal())},8,pau.getAspects(),new
            // ItemStack(WGContent.ItemPrimordialBoots),pau.getCompenents());
            // }
        ...
        WGModCompat.thaumicTinkererRegisterEnchantment(
                ...
                new AspectList().add(Aspect.AIR, 25).add(Aspect.ORDER, 20).add(Aspect.ENTROPY, 15),
                "ENCH_INVISIBLEGEAR");
        ...
        WGModCompat.thaumicTinkererRegisterEnchantment(
                ...
                new AspectList().add(Aspect.AIR, 25).add(Aspect.ORDER, 20).add(Aspect.WATER, 10),
                "ENCH_UNVEILING");
        ...
        WGModCompat.thaumicTinkererRegisterEnchantment(
                ...
                new AspectList().add(Aspect.AIR, 10).add(Aspect.ORDER, 20).add(Aspect.EARTH, 10),
                "ENCH_STEALTH");
        ...
        WGModCompat.thaumicTinkererRegisterEnchantment(
                ...
                new AspectList().add(Aspect.AIR, 20).add(Aspect.ENTROPY, 20).add(Aspect.FIRE, 20),
                "ENCH_BACKSTAB");
        ...
        infusionAspects = new AspectList().add(Aspect.SOUL, 8).add(Aspect.MAGIC, 12).add(Aspect.GREED, 4)
            ...
            if (WGConfig.allowTransmutations) {
                ...
                if (bb) {
                    ...
                    alchemyAspects = ThaumcraftApi.objectTags.get(
                            Arrays.asList(new Object[] { ingot.getItem(), Integer.valueOf(ingot.getItemDamage()) }));
                    ...
                    ItemStack nuggets = Utilities
                            .copyStackWithSize(OreDictionary.getOres("nugget" + ItemClusters.subNames[iOre]).get(0), 3);
                    registerAlchemyRecipe(
        ...
        SpinningRecipe spin_thaumiumThread = new SpinningRecipe(
                ...
                new Object[] { Items.string, Items.string, "nuggetThaumium", "nuggetThaumium" });
        ...
        for (String name : OreDictionary.getOreNames())
            if (name.startsWith("cluster")) addBlastTrippling(name.substring("cluster".length()));
    ...
    public static void registerResearch() {
        ...
        pages = new ResearchPage[] { new ResearchPage("witchinggadgets_research_page.SPINNINGWHEEL.1"),
                ...
                new ResearchPage((ShapedArcaneRecipe) recipeList.get("SPINNINGWHEEL")),
                new ResearchPage("witchinggadgets_research_page.SPINNINGWHEEL.r1"),
                new ResearchPage("witchinggadgets_research_page.SPINNINGWHEEL.r2"),
                new ResearchPage("witchinggadgets_research_page.SPINNINGWHEEL.r3") };
        getResearchItem(
                "SPINNINGWHEEL",
                "WITCHGADG",
                researchAspects,
                ...
                0,
                0,
                new ItemStack(WGContent.BlockWoodenDevice, 1, 0)).setRound().setAutoUnlock().setPages(pages)
        ...
        pages = new ResearchPage[] { new ResearchPage("witchinggadgets_research_page.ADVANCEDROBES.1"),
                new ResearchPage((ShapelessArcaneRecipe) recipeList.get("ADVANCEDROBES_CLOTH")),
                new ResearchPage((ShapedArcaneRecipe) recipeList.get("ADVANCEDROBES_CHEST")),
                new ResearchPage((ShapedArcaneRecipe) recipeList.get("ADVANCEDROBES_LEGS")) };
        getResearchItem(
                "ADVANCEDROBES",
                "WITCHGADG",
                researchAspects,
                ...
                3,
                new ItemStack(WGContent.ItemMaterial, 1, 5))
                        .setParents(new String[] { "WG.ENCHFABRIC", "SPINNINGWHEEL" }).setPages(pages).setConcealed()
        ...
        if (WGConfig.moduleBag) {
            ...
            pages = new ResearchPage[] { new ResearchPage("witchinggadgets_research_page.BAGOFTRICKS.1"),
                    new ResearchPage((ShapelessArcaneRecipe) recipeList.get("BAGOFTRICKS_CLOTH")),
                    new ResearchPage((ShapedArcaneRecipe) recipeList.get("BAGOFTRICKS_BAG")) };
            getResearchItem(
                    "BAGOFTRICKS",
                    "WITCHGADG",
                    researchAspects,
                    ...
                    1,
                    1,
                    new ItemStack(WGContent.ItemBag, 1, 0)).setParents(new String[] { "SPINNINGWHEEL" }).setConcealed()
            ...
            if (WGConfig.bagEnder) {
                ...
                pages = new ResearchPage[] { new ResearchPage("witchinggadgets_research_page.ENDERBAG.1"),
                        new ResearchPage((InfusionRecipe) recipeList.get("ENDERBAG")) };
                getResearchItem(
                        "ENDERBAG",
                        "WITCHGADG",
                        researchAspects,
                        ...
                        2,
                        1,
                        new ItemStack(WGContent.ItemBag, 1, 2)).setPages(pages)
                                .setParents(new String[] { "BAGOFTRICKS", "INFUSION" }).setHidden().setSecondary()
                                .setItemTriggers(new ItemStack[] { new ItemStack(Blocks.ender_chest, 1, 32767) })
                                .setAspectTriggers(new Aspect[] { Aspect.ELDRITCH }).registerResearchItem();
            }
            if (WGConfig.bagHungry) {
                // HUNGERBAG
                ...
                pages = new ResearchPage[] { new ResearchPage("witchinggadgets_research_page.HUNGERBAG.1"),
                        new ResearchPage((IArcaneRecipe) recipeList.get("HUNGERBAG")) };
                getResearchItem(
                        "HUNGERBAG",
                        "WITCHGADG",
                        researchAspects,
                        ...
                        1,
                        1,
                        new ItemStack(WGContent.ItemBag, 1, 3)).setPages(pages)
                                .setParents(new String[] { "BAGOFTRICKS", "HUNGRYCHEST" }).setConcealed().setSecondary()
                                .registerResearchItem();
            }
            if (WGConfig.bagVoid) {
                ...
                new FakeResearchItem(
                        ...
                        2,
                        2,
                        ResearchCategories.getResearch("ELDRITCHMINOR").icon_resource).registerResearchItem();
                ...
                pages = new ResearchPage[] { new ResearchPage("witchinggadgets_research_page.VOIDBAG.1"),
                        new ResearchPage((InfusionRecipe) recipeList.get("VOIDBAG")) };
                getResearchItem(
                        "VOIDBAG",
                        "WITCHGADG",
                        researchAspects,
                        ...
                        1,
                        new ItemStack(WGContent.ItemBag, 1, 1))
                                .setParents(new String[] { "BAGOFTRICKS", "WG.ELDRITCHMINOR" }).setConcealed()
                                .setSecondary().setPages(pages).registerResearchItem();
            }
        }
        ...
        getResearchItem(
                ...
                1,
                1,
                new ItemStack(WGContent.ItemAdvancedScribingTools)).setParentsHidden("WGPOTIONS").setPages(
                        new ResearchPage[] { new ResearchPage("witchinggadgets_research_page.ADVANCEDSCRIBINGTOOLS.1"),
        ...
        pages = new ResearchPage[] { new ResearchPage("witchinggadgets_research_page.WGBAUBLES.1"),
                new ResearchPage((ShapedArcaneRecipe) recipeList.get("WGBAUBLES_KNOCKBACKSHOULDERS")),
                new ResearchPage("witchinggadgets_research_page.WGBAUBLES.2"),
                new ResearchPage((ShapedArcaneRecipe) recipeList.get("WGBAUBLES_WOLFVAMBRACES")),
                new ResearchPage("witchinggadgets_research_page.WGBAUBLES.3"),
                new ResearchPage((InfusionRecipe) recipeList.get("WGBAUBLES_HASTEVAMBRACES")),
                new ResearchPage("witchinggadgets_research_page.WGBAUBLES.4"),
                new ResearchPage((InfusionRecipe) recipeList.get("WGBAUBLES_DOUBLEJUMPSHOULDERS")),
                new ResearchPage("witchinggadgets_research_page.WGBAUBLES.5"),
                new ResearchPage((InfusionRecipe) recipeList.get("WGBAUBLES_SNIPERRING")),
                new ResearchPage("witchinggadgets_research_page.WGBAUBLES.6"),
                new ResearchPage((InfusionRecipe) recipeList.get("WGBAUBLES_LUCKRING")),
                new ResearchPage((ShapedArcaneRecipe) recipeList.get("WGBAUBLES_COIN")) };
        getResearchItem(
                "WGBAUBLES",
                "WITCHGADG",
                researchAspects,
                ...
                -2,
                1,
                new ItemStack(WGContent.ItemMagicalBaubles, 1, 2)).setParents("THAUMIUM").setPages(pages)
                        .registerResearchItem();
        ...
        if (WGConfig.moduleCloak) {
            ...
            pages = new ResearchPage[] { new ResearchPage("witchinggadgets_research_page.CLOAK.1"),
                    new ResearchPage((IArcaneRecipe) recipeList.get("CLOAK")) };
            getResearchItem("CLOAK", "WITCHGADG", researchAspects, 5, -4, 2, standardCloak)
                    .setParentsHidden(new String[] { "ENCHFABRIC" }).setConcealed().setPages(pages)
                    .registerResearchItem();
            ...
            if (WGConfig.capeSpectral) {
                ...
                pages = new ResearchPage[] { new ResearchPage("witchinggadgets_research_page.CLOAK_SPECTRAL.1"),
                        new ResearchPage((InfusionRecipe) recipeList.get("CLOAK_SPECTRAL")),
                ...
                getResearchItem(
                        ...
                        new ItemStack(WGContent.ItemCloak, 1, 1)).setParents("CLOAK").setParentsHidden("INFUSION")
                                .setPages(pages).setConcealed().setSecondary().registerResearchItem();
            }
            if (WGConfig.capeStorage) {
                ...
                pages = new ResearchPage[] { new ResearchPage("witchinggadgets_research_page.CLOAK_STORAGE.1"),
                        new ResearchPage((IArcaneRecipe) recipeList.get("CLOAK_STORAGE")) };
                getResearchItem(
                        "CLOAK_STORAGE",
                        "WITCHGADG",
                        researchAspects,
            ...
            if (WGConfig.capeWolf) {
                ...
                pages = new ResearchPage[] { new ResearchPage("witchinggadgets_research_page.CLOAK_WOLF.1"),
                        new ResearchPage((IArcaneRecipe) recipeList.get("CLOAK_WOLF")) };
                getResearchItem(
                        "CLOAK_WOLF",
                        "WITCHGADG",
                        researchAspects,
            ...
            if (WGModCompat.tfRavensFeather != null && WGConfig.capeRaven) {
                ...
                pages = new ResearchPage[] { new ResearchPage("witchinggadgets_research_page.CLOAK_RAVEN.1"),
                        new ResearchPage((IArcaneRecipe) recipeList.get("CLOAK_RAVEN")) };
                getResearchItem(
                        "CLOAK_RAVEN",
                        "WITCHGADG",
                        researchAspects,
        ...
        new FakeResearchItem(
                ...
                -3,
                -4,
                ResearchCategories.getResearch("ARCANESTONE").icon_item).registerResearchItem();
        // STONEEXTRUDER
        ...
        pages = new ResearchPage[] { new ResearchPage("witchinggadgets_research_page.STONEEXTRUDER.1"),
                new ResearchPage((ShapedArcaneRecipe) recipeList.get("STONEEXTRUDER")) };
        getResearchItem(
                "STONEEXTRUDER",
                "WITCHGADG",
                researchAspects,
                ...
                -6,
                1,
                new ItemStack(WGContent.BlockWoodenDevice, 1, 2)).setParents("WG.ARCANESTONE", "THAUMIUM")
                        .setPages(pages).registerResearchItem();
        // AGEINGSTONE
        ...
        pages = new ResearchPage[] { new ResearchPage("witchinggadgets_research_page.AGEINGSTONE.1"),
                new ResearchPage((ShapedArcaneRecipe) recipeList.get("AGEINGSTONE")) };
        getResearchItem(
                "AGEINGSTONE",
                "WITCHGADG",
                researchAspects,
                ...
                -5,
                2,
                new ItemStack(WGContent.BlockStoneDevice, 1, 1)).addWarp(1).setParents("WG.ARCANESTONE").setPages(pages)
                        .setSecondary().registerResearchItem();
        // ETHEREALWALL
        ...
        pages = new ResearchPage[] { new ResearchPage("witchinggadgets_research_page.ETHEREALWALL.1"),
                ...
                new ResearchPage((ShapedArcaneRecipe) recipeList.get("ETHEREALWALL")) };
        getResearchItem(
                "ETHEREALWALL",
                "WITCHGADG",
                researchAspects,
                ...
                -6,
                2,
                new ItemStack(WGContent.BlockStoneDevice, 1, 0)).setParents("WG.ARCANESTONE").setPages(pages)
                        .setSecondary().registerResearchItem();
        ...
        new FakeResearchItem(
                ...
                -1,
                -4,
                ResearchCategories.getResearch("BATHSALTS").icon_item).registerResearchItem();
        // SAUNA
        ...
        pages = new ResearchPage[] { new ResearchPage("witchinggadgets_research_page.SAUNASTOVE.1"),
                ...
                new ResearchPage((ShapedArcaneRecipe) recipeList.get("SAUNASTOVE")) };
        getResearchItem(
                "SAUNASTOVE",
                "WITCHGADG",
                researchAspects,
        ...
        new FakeResearchItem(
                ...
                -2,
                2,
                ResearchCategories.getResearch("JARLABEL").icon_item).registerResearchItem();
        // LABELLIB
        ...
        pages = new ResearchPage[] { new ResearchPage("witchinggadgets_research_page.LABELLIB.1"),
                new ResearchPage((ShapedArcaneRecipe) recipeList.get("LABELLIB")) };
        getResearchItem(
                "LABELLIB",
                "WITCHGADG",
                researchAspects,
        ...
        if (Config.allowMirrors) {
            // //ORIGINAL MIRROR
            // getFakeResearchItem("MIRROR", "ARTIFICE", 2,-7, new ItemStack(ConfigBlocks.blockMirror, 1,
            // 0)).registerResearchItem();
            // //MIRROR
            // researchAspects = new AspectList().add(Aspect.VOID, 4).add(Aspect.TRAVEL, 8).add(Aspect.ELDRITCH,
            // 6).add(Aspect.CRYSTAL, 6);
            // pages = new ResearchPage[]{ new ResearchPage("witchinggadgets_research_page.WALLMIRROR.1"),new
            // ResearchPage("witchinggadgets_research_page.WALLMIRROR.2"), new
            // ResearchPage((InfusionRecipe)recipeList.get("WALLMIRROR")) };
            // getResearchItem("WALLMIRROR", "WITCHGADG", researchAspects, 1, -5, 2, new
            // ItemStack(WGContent.BlockWallMirror)).addWarp(2).setPages(pages).setParents("WGFAKEMIRROR").setSecondary().setConcealed().registerResearchItem();
            ...
            new FakeResearchItem(
                    ...
                    -2,
                    -2,
                    ResearchCategories.getResearch("MIRRORESSENTIA").icon_item).registerResearchItem();

            // MIRRORPUMP
            researchAspects = new AspectList().add(Aspect.TOOL, 1).add(Aspect.WATER, 1).add(Aspect.TRAVEL, 1)
                    .add(Aspect.SLIME, 1);
            pages = new ResearchPage[] { new ResearchPage("witchinggadgets_research_page.MIRRORPUMP.1"),
                    new ResearchPage((IArcaneRecipe) recipeList.get("MIRRORPUMP")) };
            getResearchItem(
                    "MIRRORPUMP",
                    "WITCHGADG",
                    researchAspects,
        ...
        pages = new ResearchPage[] { new ResearchPage("witchinggadgets_research_page.SCANCAMERA.1"),
                new ResearchPage((IArcaneRecipe) recipeList.get("SCANCAMERA")),
                new ResearchPage("witchinggadgets_research_page.SCANCAMERA.2"),
                new ResearchPage((IArcaneRecipe) recipeList.get("SCANCAMERA_DEVELOP")),
                new ResearchPage((IRecipe) recipeList.get("SCANCAMERA_CLEARPLATE")) };
        getResearchItem("SCANCAMERA", "WITCHGADG", researchAspects, -1, -6, 2, new ItemStack(WGContent.ItemScanCamera))
                .setPages(pages).registerResearchItem();
        // CALCULATOR
        ...
        pages = new ResearchPage[] { new ResearchPage("witchinggadgets_research_page.CALCULATOR.1"),
                new ResearchPage((IArcaneRecipe) recipeList.get("CALCULATOR")) };
        getResearchItem(
                "CALCULATOR",
                "WITCHGADG",
                researchAspects,
                ...
                -2,
                1,
                new ItemStack(WGContent.ItemMaterial, 1, 7)).setPages(pages).setParents("INFUSION")
                        .registerResearchItem();
        // LABYRINTHSTRING
        ...
        pages = new ResearchPage[] { new ResearchPage("witchinggadgets_research_page.LABYRINTHSTRING.1"),
                new ResearchPage((InfusionRecipe) recipeList.get("LABYRINTHSTRING")) };
        getResearchItem(
                "LABYRINTHSTRING",
                "WITCHGADG",
                researchAspects,
                ...
                -6,
                1,
                new ItemStack(WGContent.ItemMaterial, 1, 11)).setPages(pages).setParents("INFUSION")
                        .registerResearchItem();
        ...
        new FakeResearchItem(
                ...
                -4,
                -3,
                ResearchCategories.getResearch("ALCHEMICALMANUFACTURE").icon_resource).registerResearchItem();
        // ALCHEMICALTRANSFORM
        ...
        pages = new ResearchPage[] { new ResearchPage("witchinggadgets_research_page.ALCHEMICALTRANSMOGRIFY.1"),
                new ResearchPage((CrucibleRecipe) recipeList.get("ALCHEMICALTRANSMOGRIFY_GRASS")),
                new ResearchPage((CrucibleRecipe) recipeList.get("ALCHEMICALTRANSMOGRIFY_MYCEL")),
                new ResearchPage((CrucibleRecipe) recipeList.get("ALCHEMICALTRANSMOGRIFY_SAND")),
                new ResearchPage((CrucibleRecipe) recipeList.get("ALCHEMICALTRANSMOGRIFY_FLINT")) };
        getResearchItem("ALCHEMICALTRANSMOGRIFY", "WITCHGADG", researchAspects, -6, -3, 1, new ItemStack(Blocks.grass))
                .setSecondary().setParents(new String[] { "WG.ALCHEMICALMANUFACTURE" }).setConcealed().setPages(pages)
                .registerResearchItem();
        // ROSEVINE
        ...
        pages = new ResearchPage[] { new ResearchPage("witchinggadgets_research_page.ROSEVINE.1"),
                new ResearchPage((CrucibleRecipe) recipeList.get("ROSEVINE")) };
        getResearchItem("ROSEVINE", "WITCHGADG", researchAspects, -6, -4, 1, new ItemStack(WGContent.BlockRoseVine))
                .setSecondary().setParents("WG.ALCHEMICALMANUFACTURE").setConcealed().setPages(pages)
                .registerResearchItem();
        ...
        new FakeResearchItem(
                ...
                -5,
                0,
                ResearchCategories.getResearch("PUREIRON").icon_item).registerResearchItem();
        // PURECINNABAR
        ...
        pages = new ResearchPage[] { new ResearchPage("witchinggadgets_research_page.PURECINNABAR.1"),
                new ResearchPage((CrucibleRecipe) recipeList.get("PURECINNABAR")) };
        getResearchItem(
                "PURECINNABAR",
                "WITCHGADG",
                researchAspects,
                ...
                1,
                1,
                new ItemStack(ConfigItems.itemNugget, 1, 21)).setConcealed().setSecondary().setParents("WG.PUREIRON")
                        .setPages(pages).registerResearchItem();
        ...
        if (WGConfig.allowClusters) {
            ...
            for (String ore : ItemClusters.subNames)
                if (recipeList.containsKey("METALLURGICPERFECTION_CLUSTERS_" + ore)) clusterPages.add(
                        new ResearchPage((CrucibleRecipe) recipeList.get("METALLURGICPERFECTION_CLUSTERS_" + ore)));
            ...
            getResearchItem(
                    ...
                    0,
                    1,
                    new ResourceLocation("witchinggadgets:textures/gui/research/icon_mp_cluster.png")).setConcealed()
                            .setSecondary().setSpecial().setParents(clusterParents.toArray(new String[0]))
                            .setPages(pages).registerResearchItem();
        }
        ...
        if (WGConfig.allowTransmutations) {
            ...
            new FakeResearchItem(
                    ...
                    -5,
                    -1,
                    ResearchCategories.getResearch("TRANSIRON").icon_item).registerResearchItem();
            ...
            for (String ore : ItemClusters.subNames)
                if (recipeList.containsKey("METALLURGICPERFECTION_TRANSMUTATION_" + ore)) transmutePages.add(
                        new ResearchPage(
                                (CrucibleRecipe) recipeList.get("METALLURGICPERFECTION_TRANSMUTATION_" + ore)));
            ...
            getResearchItem(
                    ...
                    -1,
                    1,
                    new ResourceLocation("witchinggadgets:textures/gui/research/icon_mp_trans.png")).setConcealed()
                            .setSecondary().setSpecial().setParents(transmuteParents.toArray(new String[0]))
                            .setPages(pages).registerResearchItem();
        }
        ...
        new FakeResearchItem(
                ...
                2,
                -2,
                ResearchCategories.getResearch("INFERNALFURNACE").icon_resource).registerResearchItem();
        // INFERNALBLASTFURNACE
        ...
        pages = new ResearchPage[] { new ResearchPage("witchinggadgets_research_page.INFERNALBLASTFURNACE.1"),
                ...
                new ResearchPage((List) recipeList.get("INFERNALBLASTFURNACE")),
        ...
        if (WGConfig.moduleGemcutting) {
            ...
            pages = new ResearchPage[] { new ResearchPage("witchinggadgets_research_page.GEMCUTTING.1"),
                    new ResearchPage((ShapedOreRecipe) recipeList.get("GEMCUTTING_TOOLS")),
                    new ResearchPage((List) recipeList.get("GEMCUTTING")),
                    ...
                    new ResearchPage(
                            "witchinggadgets_research_page.GEMCUTTING.7"
                                    + (!Config.allowMirrors ? ".noMirrors" : "")) };
            getResearchItem(
                    "GEMCUTTING",
                    "WITCHGADG",
                    researchAspects,
            ...
            pages = new ResearchPage[] { new ResearchPage("witchinggadgets_research_page.CRYSTALCAPSULE.1"),
                    new ResearchPage((CrucibleRecipe) recipeList.get("CRYSTALCAPSULE")) };
            getResearchItem(
                    "CRYSTALCAPSULE",
                    "WITCHGADG",
                    researchAspects,
                    ...
                    -3,
                    2,
                    new ItemStack(WGContent.ItemCapsule)).setPages(pages).setSecondary().setParents("GEMCUTTING")
                            .registerResearchItem();
        ...
        pages = new ResearchPage[] { new ResearchPage("witchinggadgets_research_page.ENCH_INVISIBLEGEAR.1"),
                new ResearchPage((InfusionEnchantmentRecipe) recipeList.get("ENCH_INVISIBLEGEAR")) };
        getResearchItem(
                "ENCH_INVISIBLEGEAR",
                "WITCHGADG",
                researchAspects,
                ...
                new ResourceLocation("witchinggadgets:textures/gui/research/icon_ench_invisGear.png"))
                        .setParents("WG.INFUSIONENCHANTMENT").setConcealed().setSecondary().setPages(pages)
                        .registerResearchItem();
        // ENCH_REVEALING
        ...
        pages = new ResearchPage[] { new ResearchPage("witchinggadgets_research_page.ENCH_UNVEILING.1"),
                new ResearchPage((InfusionEnchantmentRecipe) recipeList.get("ENCH_UNVEILING")) };
        getResearchItem(
                "ENCH_UNVEILING",
                "WITCHGADG",
                researchAspects,
        ...
        pages = new ResearchPage[] { new ResearchPage("witchinggadgets_research_page.ENCH_STEALTH.1"),
                new ResearchPage((InfusionEnchantmentRecipe) recipeList.get("ENCH_STEALTH")) };
        getResearchItem(
                "ENCH_STEALTH",
                "WITCHGADG",
                researchAspects,
        ...
        pages = new ResearchPage[] { new ResearchPage("witchinggadgets_research_page.ENCH_BACKSTAB.1"),
                new ResearchPage((InfusionEnchantmentRecipe) recipeList.get("ENCH_BACKSTAB")) };
        getResearchItem(
                "ENCH_BACKSTAB",
                "WITCHGADG",
                researchAspects,
                ...
                new ResourceLocation("witchinggadgets:textures/gui/research/icon_ench_backstab.png"))
                        .setParents("ENCH_STEALTH").setConcealed().setSecondary().setPages(pages)
                        .registerResearchItem();
        // ENCH_RIDEPROTECT
        ...
        pages = new ResearchPage[] { new ResearchPage("witchinggadgets_research_page.ENCH_RIDEPROTECT.1"),
                new ResearchPage((InfusionEnchantmentRecipe) recipeList.get("ENCH_RIDEPROTECT")) };
        getResearchItem(
                "ENCH_RIDEPROTECT",
                "WITCHGADG",
                researchAspects,
        ...
        pages = new ResearchPage[] { new ResearchPage("witchinggadgets_research_page.ENCH_SOULBOUND.1"),
                new ResearchPage((InfusionEnchantmentRecipe) recipeList.get("ENCH_SOULBOUND")),
                new ResearchPage((ShapedArcaneRecipe) recipeList.get("ENCH_SOULBOUND_BOOK")) };
        getResearchItem(
                "ENCH_SOULBOUND",
                "WITCHGADG",
                researchAspects,
        ...
        if (WGConfig.terraformer) {
            ...
            new FakeResearchItem(
                    ...
                    5,
                    -5,
                    new ItemStack(ConfigBlocks.blockTube, 1, 2)).registerResearchItem();
            // TERRAFORMER
            researchAspects = new AspectList().add(Aspect.EARTH, 2).add(Aspect.EXCHANGE, 1).add(Aspect.ENERGY, 1)
            ...
            pages = new ResearchPage[] { new ResearchPage("witchinggadgets_research_page.TERRAFORMER.1"),
                    new ResearchPage((InfusionRecipe) recipeList.get("TERRAFORMER")) };
            getResearchItem(
                    "TERRAFORMER",
                    "WITCHGADG",
                    researchAspects,
                    ...
                    -7,
                    2,
                    new ItemStack(WGContent.BlockMetalDevice, 1, 2)).setPages(pages).setParents("WG.CENTRIFUGE")
                            .registerResearchItem();
            ...
            pages = new ResearchPage[] { new ResearchPage("witchinggadgets_research_page.TERRAFORMFOCUS_PLAINS.1"),
                    new ResearchPage((IArcaneRecipe) recipeList.get("TERRAFORMFOCUS_PLAINS")) };
            getResearchItem(
                    "TERRAFORMFOCUS_PLAINS",
                    "WITCHGADG",
                    researchAspects,
                    ...
                    -7,
                    2,
                    new ItemStack(WGContent.BlockMetalDevice, 1, 3)).setSecondary().setPages(pages)
                            .setParents("TERRAFORMER").registerResearchItem();
            ...
            pages = new ResearchPage[] { new ResearchPage("witchinggadgets_research_page.TERRAFORMFOCUS_COLDTAIGA.1"),
                    new ResearchPage((IArcaneRecipe) recipeList.get("TERRAFORMFOCUS_COLDTAIGA")) };
            getResearchItem(
                    "TERRAFORMFOCUS_COLDTAIGA",
                    "WITCHGADG",
                    researchAspects,
                    ...
                    -9,
                    2,
                    new ItemStack(WGContent.BlockMetalDevice, 1, 4)).setSecondary().setPages(pages)
                            .setParents("TERRAFORMER").registerResearchItem();
            ...
            pages = new ResearchPage[] { new ResearchPage("witchinggadgets_research_page.TERRAFORMFOCUS_DESERT.1"),
                    new ResearchPage((IArcaneRecipe) recipeList.get("TERRAFORMFOCUS_DESERT")) };
            getResearchItem(
                    "TERRAFORMFOCUS_DESERT",
                    "WITCHGADG",
                    researchAspects,
                    ...
                    -8,
                    2,
                    new ItemStack(WGContent.BlockMetalDevice, 1, 5)).setSecondary().setPages(pages)
                            .setParents("TERRAFORMER").registerResearchItem();
            ...
            pages = new ResearchPage[] { new ResearchPage("witchinggadgets_research_page.TERRAFORMFOCUS_JUNGLE.1"),
                    new ResearchPage((IArcaneRecipe) recipeList.get("TERRAFORMFOCUS_JUNGLE")) };
            getResearchItem(
                    "TERRAFORMFOCUS_JUNGLE",
                    "WITCHGADG",
                    researchAspects,
                    ...
                    -9,
                    2,
                    new ItemStack(WGContent.BlockMetalDevice, 1, 6)).setSecondary().setPages(pages)
                            .setParents("TERRAFORMER").registerResearchItem();
            ...
            pages = new ResearchPage[] { new ResearchPage("witchinggadgets_research_page.TERRAFORMFOCUS_HELL.1"),
                    new ResearchPage((IArcaneRecipe) recipeList.get("TERRAFORMFOCUS_HELL")) };
            getResearchItem(
                    "TERRAFORMFOCUS_HELL",
                    "WITCHGADG",
                    researchAspects,
                    ...
                    -9,
                    2,
                    new ItemStack(WGContent.BlockMetalDevice, 1, 7)).addWarp(2).setSecondary().setPages(pages)
                            .setParents("TERRAFORMER").registerResearchItem();
            ...
            pages = new ResearchPage[] { new ResearchPage("witchinggadgets_research_page.TERRAFORMFOCUS_MUSHROOM.1"),
                    new ResearchPage((IArcaneRecipe) recipeList.get("TERRAFORMFOCUS_MUSHROOM")) };
            getResearchItem(
                    "TERRAFORMFOCUS_MUSHROOM",
                    "WITCHGADG",
                    researchAspects,
                    ...
                    -8,
                    2,
                    new ItemStack(WGContent.BlockMetalDevice, 1, 9)).setSecondary().setPages(pages)
                            .setParents("TERRAFORMER").registerResearchItem();
            ...
            pages = new ResearchPage[] { new ResearchPage("witchinggadgets_research_page.TERRAFORMFOCUS_TAINT.1"),
                    new ResearchPage((InfusionRecipe) recipeList.get("TERRAFORMFOCUS_TAINT")) };
            getResearchItem(
                    "TERRAFORMFOCUS_TAINT",
                    "WITCHGADG",
                    researchAspects,
                    ...
                    -7,
                    2,
                    new ItemStack(WGContent.BlockMetalDevice, 1, 8)).addWarp(3).setSecondary().setPages(pages)
                            .setParents("TERRAFORMER", "BOTTLETAINT").registerResearchItem();
            ...
            pages = new ResearchPage[] { new ResearchPage("witchinggadgets_research_page.TERRAFORMFOCUS_RIVER.1"),
                    new ResearchPage((InfusionRecipe) recipeList.get("TERRAFORMFOCUS_RIVER")) };
            getResearchItem(
                    "TERRAFORMFOCUS_RIVER",
                    "WITCHGADG",
                    researchAspects,
                    ...
                    -6,
                    2,
                    new ItemStack(WGContent.BlockMetalDevice, 1, 10)).setSecondary().setPages(pages)
                            .setParents("TERRAFORMER").registerResearchItem();

            researchAspects = new AspectList().add(Aspect.WATER, 8).add(Aspect.MAGIC, 4).add(Aspect.EXCHANGE, 2)
                    .add(Aspect.ENERGY, 1);
            pages = new ResearchPage[] { new ResearchPage("witchinggadgets_research_page.TERRAFORMFOCUS_OCEAN.1"),
                    new ResearchPage((InfusionRecipe) recipeList.get("TERRAFORMFOCUS_OCEAN")) };
            getResearchItem(
                    "TERRAFORMFOCUS_OCEAN",
                    "WITCHGADG",
                    researchAspects,
                    ...
                    -6,
                    2,
                    new ItemStack(WGContent.BlockMetalDevice, 1, 11)).setSecondary().setPages(pages)
                            .setParents("TERRAFORMFOCUS_RIVER").registerResearchItem();
            ...
            pages = new ResearchPage[] { new ResearchPage("witchinggadgets_research_page.TERRAFORMFOCUS_END.1"),
                    new ResearchPage((InfusionRecipe) recipeList.get("TERRAFORMFOCUS_END")) };
            getResearchItem(
                    "TERRAFORMFOCUS_END",
                    "WITCHGADG",
                    researchAspects,
                    ...
                    -5,
                    2,
                    new ItemStack(WGContent.BlockMetalDevice, 1, 12)).addWarp(3).setSecondary().setPages(pages)
                            .setParents("TERRAFORMER").registerResearchItem();
        } ;
        ...
        if (WGConfig.modulePrimal) {
            ...
            pages = new ResearchPage[] { new ResearchPage("witchinggadgets_research_page.EMPOWERPEARL.1"),
                    new ResearchPage((InfusionRecipe) recipeList.get("EMPOWERPEARL")) };
            getResearchItem(
                    "EMPOWERPEARL",
                    "WITCHGADG",
                    researchAspects,
                    ...
                    2,
                    1,
                    new ItemStack(WGContent.ItemMaterial, 1, 12)).setSecondary().setParents("WG.PRIMPEARL")
            ...
            if (WGConfig.moduleGemcutting) {
                ...
                pages = new ResearchPage[] { new ResearchPage("witchinggadgets_research_page.PRIMORDIALGLOVE.1"),
                        new ResearchPage((InfusionRecipe) recipeList.get("PRIMORDIALGLOVE")),
            ...
            pages = new ResearchPage[] { new ResearchPage("witchinggadgets_research_page.PRIMORDIALWEAPONRY.1"),
                    ...
                    new ResearchPage((InfusionRecipe) recipeList.get("PRIMORDIALWEAPONRY_CLAYMORE")),
                    new ResearchPage((InfusionRecipe) recipeList.get("PRIMORDIALWEAPONRY_HAMMER")),
                    new ResearchPage((InfusionRecipe) recipeList.get("PRIMORDIALWEAPONRY_GREATAXE")) };
            getResearchItem(
                    "PRIMORDIALWEAPONRY",
                    "WITCHGADG",
                    researchAspects,
            ...
            // //PRIMORDIALCLAYMORE
            // researchAspects = new AspectList().add(Aspect.WEAPON, 1).add(Aspect.MAGIC,
            // 1).add(Aspect.AIR,1).add(Aspect.FIRE,1).add(Aspect.WATER,1).add(Aspect.EARTH,1).add(Aspect.ORDER,1).add(Aspect.ENTROPY,1);
            // pages = new ResearchPage[]{ new ResearchPage("witchinggadgets_research_page.PRIMORDIALCLAYMORE.1"), new
            // ResearchPage((InfusionRecipe) recipeList.get("PRIMORDIALCLAYMORE"))};
            // getResearchItem("PRIMORDIALCLAYMORE", "WITCHGADG", researchAspects, -4, 2, 3, new
            // ItemStack(WGContent.ItemPrimordialSword)).setParents("PRIMORDIALGEARSET","ELEMENTALSWORD").setConcealed().setPages(pages).registerResearchItem();
            // //PRIMORDIALHAMMER
            // researchAspects = new AspectList().add(Aspect.WEAPON, 1).add(Aspect.TOOL, 1).add(Aspect.MAGIC,
            // 1).add(Aspect.AIR,1).add(Aspect.FIRE,1).add(Aspect.WATER,1).add(Aspect.EARTH,1).add(Aspect.ORDER,1).add(Aspect.ENTROPY,1);
            // pages = new ResearchPage[]{ new ResearchPage("witchinggadgets_research_page.PRIMORDIALHAMMER.1"), new
            // ResearchPage((InfusionRecipe) recipeList.get("PRIMORDIALHAMMER"))};
            // getResearchItem("PRIMORDIALHAMMER", "WITCHGADG", researchAspects, -4, 3, 3, new
            // ItemStack(WGContent.ItemPrimordialHammer)).setParents("PRIMORDIALGEARSET","ELEMENTALPICK").setConcealed().setPages(pages).registerResearchItem();
            // //PRIMORDIALGREATAXE
            // researchAspects = new AspectList().add(Aspect.WEAPON, 1).add(Aspect.TOOL, 1).add(Aspect.MAGIC,
            // 1).add(Aspect.AIR,1).add(Aspect.FIRE,1).add(Aspect.WATER,1).add(Aspect.EARTH,1).add(Aspect.ORDER,1).add(Aspect.ENTROPY,1);
            // pages = new ResearchPage[]{ new ResearchPage("witchinggadgets_research_page.PRIMORDIALGREATAXE.1"), new
            // ResearchPage((InfusionRecipe) recipeList.get("PRIMORDIALGREATAXE"))};
            // getResearchItem("PRIMORDIALGREATAXE", "WITCHGADG", researchAspects, -4, 4, 3, new
            // ItemStack(WGContent.ItemPrimordialAxe)).setParents("PRIMORDIALGEARSET","ELEMENTALAXE").setConcealed().setPages(pages).registerResearchItem();
            ...
            pages = new ResearchPage[] { new ResearchPage("witchinggadgets_research_page.PRIMORDIALARMOR.1"),
                    ...
                    new ResearchPage((InfusionRecipe) recipeList.get("PRIMORDIALARMOR_HELMET")),
                    new ResearchPage((InfusionRecipe) recipeList.get("PRIMORDIALARMOR_CUIRASS")),
                    new ResearchPage((InfusionRecipe) recipeList.get("PRIMORDIALARMOR_GREAVES")),
                    new ResearchPage((InfusionRecipe) recipeList.get("PRIMORDIALARMOR_BOOTS")) };
            getResearchItem(
                    "PRIMORDIALARMOR",
                    "WITCHGADG",
                    researchAspects,
                    ...
                    new ResourceLocation("witchinggadgets:textures/gui/research/icon_primordialArmor.png"))
                            ...
                            .registerResearchItem();
            // //PRIMORDIALCUIRASS
            // researchAspects = new AspectList().add(Aspect.ARMOR, 1).add(Aspect.MAGIC,
            // 1).add(Aspect.AIR,1).add(Aspect.FIRE,1).add(Aspect.WATER,1).add(Aspect.EARTH,1).add(Aspect.ORDER,1).add(Aspect.ENTROPY,1);
            // pages = new ResearchPage[]{ new ResearchPage("witchinggadgets_research_page.PRIMORDIALCUIRASS.1"), new
            // ResearchPage((InfusionRecipe) recipeList.get("PRIMORDIALCUIRASS"))};
            // getResearchItem("PRIMORDIALCUIRASS", "WITCHGADG", researchAspects, -1, 6, 3, new
            // ItemStack(WGContent.ItemPrimordialChest)).setParents("PRIMORDIALGEARSET").setConcealed().setPages(pages).registerResearchItem();
            // //PRIMORDIALGREAVES
            // researchAspects = new AspectList().add(Aspect.ARMOR, 1).add(Aspect.MAGIC,
            // 1).add(Aspect.AIR,1).add(Aspect.FIRE,1).add(Aspect.WATER,1).add(Aspect.EARTH,1).add(Aspect.ORDER,1).add(Aspect.ENTROPY,1);
            // pages = new ResearchPage[]{ new ResearchPage("witchinggadgets_research_page.PRIMORDIALGREAVES.1"), new
            // ResearchPage((InfusionRecipe) recipeList.get("PRIMORDIALGREAVES"))};
            // getResearchItem("PRIMORDIALGREAVES", "WITCHGADG", researchAspects, 0, 6, 3, new
            // ItemStack(WGContent.ItemPrimordialLegs)).setParents("PRIMORDIALGEARSET").setConcealed().setPages(pages).registerResearchItem();
            // //PRIMORDIALBOOTS
            // researchAspects = new AspectList().add(Aspect.ARMOR, 1).add(Aspect.MAGIC,
            // 1).add(Aspect.AIR,1).add(Aspect.FIRE,1).add(Aspect.WATER,1).add(Aspect.EARTH,1).add(Aspect.ORDER,1).add(Aspect.ENTROPY,1);
            // pages = new ResearchPage[]{ new ResearchPage("witchinggadgets_research_page.PRIMORDIALBOOTS.1"), new
            // ResearchPage((InfusionRecipe) recipeList.get("PRIMORDIALBOOTS"))};
            // getResearchItem("PRIMORDIALBOOTS", "WITCHGADG", researchAspects, 1, 5, 3, new
            // ItemStack(WGContent.ItemPrimordialBoots)).setParents("PRIMORDIALGEARSET").setConcealed().setPages(pages).registerResearchItem();
    ...
    public static void modifyStandardThaumcraftResearch() {
        ...
        for (int i = 0; i < 7; i++) newPages[i] = pages[i];
        newPages[7] = new ResearchPage((IRecipe) recipeList.get("THAUMIUMSHEARS"));
        for (int i = 8; i < newPages.length; i++) newPages[i] = pages[i - 1];
        thaumium.setPages(newPages);
    }

    private static void registerArcaneRecipe(String tag, String tagAddon, ItemStack result, AspectList craftingAspects,
            Object... recipe) {
    ...
    private static void registerShapelessArcaneRecipe(String tag, String tagAddon, ItemStack result,
            AspectList craftingAspects, Object... recipe) {
        ShapelessArcaneRecipe arcaneRecipe = ThaumcraftApi
                .addShapelessArcaneCraftingRecipe(tag, result, craftingAspects, recipe);
        recipeList.put(tag + tagAddon, arcaneRecipe);
    }

    private static void registerAlchemyRecipe(String tag, String tagAddon, ItemStack result, Object catalyst,
            AspectList alchemyAspects) {
    ...
    /*
     * private static WGFakeResearchItem getFakeResearchItem(String original, String originalCat, int xPos, int yPos,
     * Object icon) { WGFakeResearchItem item = null; if(icon instanceof ItemStack) item = new
     * WGFakeResearchItem("WGFAKE"+original, "WITCHGADG", original, originalCat, xPos, yPos, (ItemStack)icon); if(icon
     * instanceof ResourceLocation) item = new WGFakeResearchItem("WGFAKE"+original, "WITCHGADG", original, originalCat,
     * xPos, yPos, (ResourceLocation) icon); return item; }
     */
    ...
    // private static WGResearchItem getResearchItem(String tag, String category, AspectList researchAspects, int xPos,
    // int yPos, int complexity, ResourceLocation icon)
    // {
